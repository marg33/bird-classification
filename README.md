...
## Problem Overview
The problem was to train a multiclass image classifier to identify different types of birds. The evaluation metric is the accuracy on the test data.
